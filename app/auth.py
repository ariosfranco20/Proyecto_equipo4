    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if user is not None:
                ...
                content = 'Hola!, has silicitado cambio de contraseña para ingresar a nuestra APP MSSG, para cambiar su contraseña, por favor haga clic en este enlace ' + flask.url_for('auth.change', _external=True) + '?auth=' + number
                
                send_email(credentials, receiver=email, subject='Solicitud cambio de contraseña MSSG', message=content)
